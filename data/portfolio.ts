...
export const projects: Project[] = [
  {
    title:'codeDoctor',
    description:
    "Une application d'accompagnement pour les dévéloppeurs , permettant de les aidez à résoudre les bugs pendant le travail et aide aussi à cultiver se désire de comprendre les bugs",
